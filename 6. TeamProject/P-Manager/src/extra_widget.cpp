...
EXTRA::EXTRA(std::string _name, QWidget *parent) :
    QWidget(parent),
    ui(new Ui::extra)
{
    name = _name;
    ...
    for(int i=0; i<8; i++) {
        ptr[i] = new Sumin::ExtraCourse;
        ptr_2[i]= new Sumin::ExtraCourse;
        ptr_3[i] = new Sumin::ExtraCourse;
        ptr_4[i] = new Sumin::ExtraCourse;
    }
    sem1=0;
    sem2=0;
    sem2_1=0;
...
void EXTRA::Tab_1_checkbox(int arg)
{
    if(sem1==0)
        sem1=1;
    else if(sem1==1)
...
void EXTRA::Tab_2_checkbox(int arg)
{
    if(sem2_1==0)
        sem2_1=1;
    else if(sem2_1==1)
...
void EXTRA::Tab_3_checkbox(int arg)
{
    if(sem3_1==0)
        sem3_1=1;
    else if(sem3_1==1)
...
void EXTRA::Tab_4_checkbox(int arg)
{
    if(sem4_1==0)
        sem4_1=1;
    else if(sem4_1==1)
...
void EXTRA::Tab_1_checkbox_2(int arg1)
{
    if(sem2==0)
        sem2=1;
    else if(sem2==1)
...
void EXTRA::Tab_2_checkbox_2(int arg1)
{
    if(sem2_2==0)
        sem2_2=1;
    else if(sem2_2==1)
...
void EXTRA::Tab_3_checkbox_2(int arg1)
{
    if(sem3_2==0)
        sem3_2=1;
    else if(sem3_2==1)
...
void EXTRA::Tab_4_checkbox_2(int arg1)
{
    if(sem4_2==0)
        sem4_2=1;
    else if(sem4_2==1)
...
void EXTRA::Tab_1_Save()
{
    std::string file_path;
    file_path = "commandLog_ExtraCourse";
